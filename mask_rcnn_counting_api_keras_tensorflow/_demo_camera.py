...
COCO_MODEL_PATH = "/home/ahmetozlu/Desktop/Traffic Analysis/zzz_1/video_edit/Mask_RCNN-master/mask_rcnn_skin_0190.h5"

# Save processed frames as a video
fourcc = cv2.VideoWriter_fourcc(*'XVID')
output_movie = cv2.VideoWriter('720p_25fps_out.avi', fourcc, 25, (1920, 1080))
...
class_names = ['BG', 'person', 'bicycle', 'car', 'motorcycle', 'airplane',
               ...
               'teddy bear', 'hair drier', 'toothbrush', 'skin', 'damage']
...
#cap = cv2.VideoCapture('720p_25fps.mp4')

try:

       
    image1 = cv2.imread('image_20181018_102736_669811981.jpg', 0)
    ...
    cv2.imwrite("asd.png", masked_image_batch[0])
    print("done...")
